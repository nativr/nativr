...
|        3 |            86 | `data`        |           7.7% |        8 |             16 |
|        4 |            97 | `write.csv`   |           7.0% |        7 |             15 |
|        5 |           121 | `png`         |           5.5% |        5 |              7 |
|        6 |           126 | `read.csv`    |           5.3% |        6 |             11 |
|        7 |           127 | `system.time` |           5.3% |        6 |             95 |
|        8 |           129 | `dir.create`  |           5.1% |        4 |              6 |
|        9 |           135 | `list.files`  |           4.8% |        4 |              6 |
|       10 |           138 | `par`         |           4.6% |        5 |             23 |
...
(`R.home`, `dir.create`, `list.files`), package data, timing, and tabular text formats. Dynamic
...
341 `open` and its adjacent `flush`, `isOpen`, and `seek` operations use the same handles. The
generated callable figure therefore keeps `R.home` as the highest-reach absent core name. Grouped
