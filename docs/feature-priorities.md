...
|        1 |           184 | `ls`             |           3.0% |        3 |              5 |
|        2 |           186 | `hist`           |           3.0% |        4 |             19 |
|        3 |           188 | `showClass`      |           2.9% |        2 |              4 |
|        4 |           189 | `packageVersion` |           2.9% |        2 |              3 |
|        5 |           194 | `Sys.getpid`     |           2.8% |        3 |              6 |
|        6 |           195 | `.libPaths`      |           2.8% |        2 |              6 |
|        7 |           196 | `example`        |           2.8% |        3 |              4 |
|        8 |           203 | `gzcon`          |           2.5% |        2 |              6 |
|        9 |           204 | `vignette`       |           2.4% |        2 |              5 |
|       10 |           205 | `args`           |           2.4% |        2 |              3 |
...
family remain explicit compatibility depth. Rank 22 `plot` is now available for all 179 measured
