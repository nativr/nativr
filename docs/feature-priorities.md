...
| -------: | ------------: | ------------------ | -------------: | -------: | -------------: |
|        1 |           188 | `showClass`        |           2.9% |        2 |              4 |
|        2 |           189 | `packageVersion`   |           2.9% |        2 |              3 |
|        3 |           194 | `Sys.getpid`       |           2.8% |        3 |              6 |
|        4 |           195 | `.libPaths`        |           2.8% |        2 |              6 |
|        5 |           196 | `example`          |           2.8% |        3 |              4 |
|        6 |           203 | `gzcon`            |           2.5% |        2 |              6 |
|        7 |           204 | `vignette`         |           2.4% |        2 |              5 |
|        8 |           205 | `args`             |           2.4% |        2 |              3 |
|        9 |           208 | `registerS3method` |           2.4% |        2 |              2 |
|       10 |           209 | `file.info`        |           2.4% |        3 |              3 |
