...
|        2 |            65 | `file`        |           9.7% |        8 |             16 |
|        3 |            69 | `close`       |           9.2% |        8 |             17 |
|        4 |            71 | `tempdir`     |           9.0% |        9 |             26 |
|        5 |            80 | `dev.off`     |           7.8% |        8 |             18 |
|        6 |            86 | `data`        |           7.7% |        8 |             16 |
|        7 |            97 | `write.csv`   |           7.0% |        7 |             15 |
|        8 |           121 | `png`         |           5.5% |        5 |              7 |
|        9 |           125 | `file.exists` |           5.4% |        5 |              8 |
|       10 |           126 | `read.csv`    |           5.3% |        6 |             11 |
...
`plot`, `Sys.sleep`, `writeLines`, and `readLines` now have executable browser-memory/package-
bundle/graphics paths. The remaining leaders divide across graphics/device architecture (`dev.off`,
`png`), browser-safe host/resource adapters (`R.home`, `tempdir`, `file.exists`), connection
architecture (`file`, `close`), package data, and tabular text formats. Dynamic caller lookup
...
roundtrips and immutable package-text reads. The generated callable figure therefore advances to
`R.home` as the highest-reach absent core name. Grouped `split` (rank 155) and real-vector `floor`
