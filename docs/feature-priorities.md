...
| -------: | ------------: | ---------------- | -------------: | -------: | -------------: |
|        1 |           177 | `as.difftime`    |           3.3% |        2 |              2 |
|        2 |           184 | `ls`             |           3.0% |        3 |              5 |
|        3 |           186 | `hist`           |           3.0% |        4 |             19 |
|        4 |           188 | `showClass`      |           2.9% |        2 |              4 |
|        5 |           189 | `packageVersion` |           2.9% |        2 |              3 |
|        6 |           194 | `Sys.getpid`     |           2.8% |        3 |              6 |
|        7 |           195 | `.libPaths`      |           2.8% |        2 |              6 |
|        8 |           196 | `example`        |           2.8% |        3 |              4 |
|        9 |           203 | `gzcon`          |           2.5% |        2 |              6 |
|       10 |           204 | `vignette`       |           2.4% |        2 |              5 |
...
allows and implements them. The default browser runtime still has no process capability. Rank 22
