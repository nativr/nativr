...
| -------: | ------------: | ------------------ | -------------: | -------: | -------------: |
|        1 |           349 | `find.package`     |           1.1% |        1 |              1 |
|        2 |           351 | `l10n_info`        |           1.1% |        1 |              1 |
|        3 |           353 | `shQuote`          |           1.1% |        1 |              1 |
|        4 |           357 | `system2`          |           1.1% |        1 |              1 |
|        5 |           358 | `.Call`            |           1.0% |        1 |              1 |
|        6 |           363 | `aspell`           |           1.0% |        1 |              2 |
|        7 |           364 | `abline`           |           1.0% |        1 |              1 |
|        8 |           365 | `browseVignettes`  |           1.0% |        1 |              1 |
|        9 |           366 | `dev.control`      |           1.0% |        1 |              1 |
|       10 |           368 | `getFromNamespace` |           0.9% |        1 |             37 |
...
`file.copy` now stages exact package resources into session paths; rank 349 `find.package` is next.
...
348 `file.copy` is complete for xfun's package-resource staging path; rank 349 `find.package` is the
...
virtual filesystem; `find.package` remains package-loader adapter work. Rank 357 `is.factor` was
already supported; rank 358 `l10n_info` remains host-locale adapter work. Rank 359 `lsfit` is now
