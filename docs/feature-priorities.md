...
| -------: | ------------: | -------------------- | -------------: | -------: | -------------: |
|        1 |           232 | `url`                |           2.1% |        2 |              6 |
|        2 |           239 | `filter`             |           1.9% |        2 |              2 |
|        3 |           245 | `packageDescription` |           1.9% |        1 |              1 |
|        4 |           246 | `stdout`             |           1.9% |        1 |              1 |
|        5 |           252 | `rainbow`            |           1.8% |        2 |              5 |
|        6 |           253 | `rect`               |           1.8% |        2 |              3 |
|        7 |           256 | `file.remove`        |           1.8% |        2 |              4 |
|        8 |           259 | `readChar`           |           1.7% |        2 |              2 |
|        9 |           262 | `terrain.colors`     |           1.7% |        1 |              3 |
|       10 |           277 | `debug`              |           1.7% |        1 |              1 |
...
abort recovery, and byte-exact echo formatting remain separate depth. Rank 230 `base::readline` is
now complete for the two measured curl/crayon calls (2.1% download-weighted reach). A typed,
...
secret policy remain host-owned. The next measured unresolved callable is rank 232 `url`. Rank 144
