...
budget; package resource count is independently bounded and decoded immutable resource bytes have a
64 MiB aggregate ceiling. All enter one immutable package-file lookup seam. UTF-8 uses the
