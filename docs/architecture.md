...
method or objects. `utils::demo` likewise builds only an owned empty catalog; external demo
discovery is reserved for the future package-loader layer rather than a host R installation.
