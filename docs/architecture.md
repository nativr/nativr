...
and decoded resource bytes have a fixed 64 MiB aggregate ceiling. Header/data payload size therefore
cannot silently raise the executable-code parsing budget.
