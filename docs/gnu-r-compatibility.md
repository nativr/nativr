...
| Package execution  | Namespace loading, lazy data, S3/S4 registration, bytecode-equivalent semantics, package resources, and R CMD check behavior                                                                           | Application-supplied pure-R bundles now have initial executable evidence for DESCRIPTION/NAMESPACE validation, bounded source parsing, dependency-ordered isolated namespaces, imports/exports, `::`/`:::`, S3 registration, lifecycle hooks, attachment, Worker transport, and reset/reload. Arbitrary installation, dependency-version enforcement, lazy data, resources, native code, S4 namespace registration, bytecode-equivalent behavior, R CMD check, and the broader domain remain incomplete                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
The first pure-R package increment is NativR-owned integration evidence rather than a claim that an
external CRAN package passes unchanged. Two independently authored bundles exercise dependency
ordering, isolated imports, exports and internals, `library()` attachment, namespace queries,
