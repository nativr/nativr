...
environment and binding locks, and non-dispatching subset primitives. These four package/version
proofs are not universal package compatibility.
...
field mutation. It does not claim active/private binding fidelity, cloning/finalization, complete
R6, or arbitrary-package compatibility.
