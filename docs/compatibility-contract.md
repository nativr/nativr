...
`evaluate 1.0.5`, `numDeriv 2016.8-1.1`, `abind 1.4-8`, `rprojroot 2.1.1`, `rstudioapi 0.19.0`, and
`inline 0.3.21` sources. The third holdout rotation evaluated `evaluate` and `numDeriv` without
