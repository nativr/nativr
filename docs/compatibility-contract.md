...
follows the pinned executable oracle. The ragg device itself, WebP animation encoding, general
device registration, cursors, and arbitrary third-party device callbacks are not included.
