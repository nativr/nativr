...
NeedsCompilation: no`,
  namespace:
    "export(twice_mean, signature_names, dynamic_summary, resource_size, event_colours, classic_palettes, usage_rectangles, plot_series, find_tools, create_file, remove_files, fixed_text, custom_axis, sourced_value, ask_user, remote_lines, filtered_flow, package_summary, standard_output)",
  rSources: [
    {
      path: "R/twice-mean.R",
      source:
