...
NeedsCompilation: no`,
  namespace:
    "export(twice_mean, signature_names, dynamic_summary, resource_size, archive_lines, event_colours, classic_palettes, usage_rectangles, plot_series, annotated_plot, find_tools, create_file, copy_resource, remove_files, fixed_text, custom_axis, sourced_value, ask_user, remote_lines, download_resource, repository_versions, pipe_lines, socket_exchange, filtered_flow, package_summary, package_files, native_encoding, standard_output, sink_lines, write_sass_variable)",
  rSources: [
    {
      path: "R/twice-mean.R",
      source:
